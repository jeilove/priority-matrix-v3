        ...
        <div className="container" style={{ paddingTop: '20px' }}>
            ...
            <style jsx>{`
                ...
                @media (max-width: 768px) {
                  ...
                  .q-blend { mix-blend-mode: multiply; filter: brightness(1.1); }
